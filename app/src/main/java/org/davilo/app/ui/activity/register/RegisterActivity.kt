...
class RegisterActivity : AppCompatActivity() {
    ...
    private val activityViewModel: RegisterActivityViewModel by viewModels()
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityViewModel.registerFormState.observe(this@RegisterActivity, Observer {
...
//        })
        ...
        password.apply {
            ...
            login.setOnClickListener {
                ...
                activityViewModel.register(username.text.toString(), password.text.toString())
            }
        }
    }
